...
df = pd.read_csv("C:\Musfique's Folder\Python\OOPProject\Data Set\Daily Ave Humidity Till Jun 2014-csv.csv", names = headers)
df1 = df.copy()
...
def creat_humidity_df(month_index, year, district):
    ...
    final_df.rename(columns={month_index: 'Humidity'}, inplace=True)
